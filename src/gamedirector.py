    ...
    def loop(self):
        while not self.quit_flag:
            ...
            if b_movie and self.frame % (self.fps / movie_framerate) == 0:
                pygame.image.save(self.screen, "screens/screen_%04d.jpg" % (
                            self.frame / (self.fps / movie_framerate) + outnumoffset))
                # pygame.image.save(self.screen,"screens/screen_%04d.png"%(self.frame/(self.fps/movie_framerate)
                # + outnumoffset))
